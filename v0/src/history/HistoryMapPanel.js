...
export default function HistoryMapPanel({ graph, onSelectNode, operationNodeId }) {
    ...
    return (_jsx("div", { style: { width: "100%", height: "100%", overflow: "auto" }, children: _jsxs("svg", { viewBox: viewBox, width: "100%", height: Math.max(260, h), style: { display: "block" }, children: [layout.edges.map((e, idx) => {
                    ...
                    return (_jsxs("g", { transform: `translate(${ln.x}, ${ln.y})`, style: { cursor: "pointer" }, onClick: () => onSelectNode(ln.id), children: [_jsx("circle", { r: r + 4, fill: "none", stroke: "currentColor", strokeWidth: 2, opacity: onActivePath ? 1 : 0.35 }), _jsx("circle", { r: r, fill: "currentColor", opacity: onActivePath ? 1 : 0.65 }), isActive && (_jsx("text", { x: r + 6, y: -r - 2, fontSize: 10, fill: "currentColor", opacity: 0.8, children: "\uD83D\uDC41" })), isOperation && (_jsx("text", { x: r + 6, y: r + 12, fontSize: 10, fill: "currentColor", opacity: 0.8, children: "\u2699" })), n.has3D && (_jsxs("g", { transform: `translate(${-r - 2}, ${-r - 6})`, children: [_jsx("rect", { width: 18, height: 11, rx: 3, fill: "#2299ff" }), _jsx("text", { x: 9, y: 8.5, fontSize: 7, fontWeight: 700, fill: "#fff", textAnchor: "middle", children: "3D" })] })), _jsx("text", { x: 16, y: -6, fontSize: 13, fill: "currentColor", opacity: 0.92, children: stationTitle(n) }), stationSubtitle(n) && (_jsx("text", { x: 16, y: 12, fontSize: 11, fill: "currentColor", opacity: 0.65, children: stationSubtitle(n) }))] }, ln.id));
                })] }) }));
}
